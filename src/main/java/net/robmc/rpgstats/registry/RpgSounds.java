...
public final class RpgSounds {
    ...
    public static final RegistryObject<SoundEvent> ARCANE_BOLT = reg("spell.arcane_bolt");
    public static final RegistryObject<SoundEvent> MANA_RIFT = reg("spell.mana_rift");
    public static final RegistryObject<SoundEvent> SPELLBIND = reg("spell.spellbind");
    public static final RegistryObject<SoundEvent> ARCANE_SHIFT = reg("spell.arcane_shift");
    public static final RegistryObject<SoundEvent> ASTRAL_ANNIHILATION = reg("spell.astral_annihilation");
    ...
    public static SoundEvent forSpell(Spell spell) {
        return switch (spell) {
            ...
            case ARCANE_BOLT -> ARCANE_BOLT.get();
            case MANA_RIFT -> MANA_RIFT.get();
            case SPELLBIND -> SPELLBIND.get();
            case ARCANE_SHIFT -> ARCANE_SHIFT.get();
            case ASTRAL_ANNIHILATION -> ASTRAL_ANNIHILATION.get();
